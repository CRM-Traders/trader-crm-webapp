  ...
  template: `
    <div class="p-6">
      <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-semibold text-gray-900">Operator Details</h2>
        <button
          type="button"
      ...
      <div *ngIf="!loading && operator" class="space-y-4">
            ...
            <div class="space-y-2">
              <div>
                ...
                <span class="ml-2 text-sm text-gray-900">{{
                  operator.userFullName || 'N/A'
                }}</span>
              </div>
              <div>
                <span class="text-sm font-medium text-gray-700">Email:</span>
                <span class="ml-2 text-sm text-gray-900">{{
                  operator.userEmail || 'N/A'
                }}</span>
              </div>
              <div>
                <span class="text-sm font-medium text-gray-700">User ID:</span>
                <span class="ml-2 text-sm text-gray-900 font-mono">{{
                  operator.userId || 'N/A'
                }}</span>
              </div>
            </div>
          ...
          <div class="space-y-2">
            <div
              *ngFor="let branch of operator.branches"
              class="flex items-center justify-between p-2 bg-white rounded border-gray-200 border"
            >
              <div>
        ...
        <div
          *ngIf="operator.departments && operator.departments.length > 0"
          class="bg-gray-50 p-4 rounded-lg"
        >
          <h3 class="text-sm font-medium text-gray-500 mb-2">
