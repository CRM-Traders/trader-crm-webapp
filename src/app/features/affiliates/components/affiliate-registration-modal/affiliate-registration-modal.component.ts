      ...
      <div *ngIf="registrationSuccess">
        ...
        <div class="px-6 py-6">
          <div class="space-y-6">
            <!-- Success Message -->
            <div
              class="bg-green-50/50 dark:bg-green-900/5 border border-green-200/20 dark:border-green-800/20 rounded-lg p-4"
            >
              <div class="flex">
                ...
                <div class="ml-3">
                  <h3
                    class="text-sm font-medium text-green-800 dark:text-green-500"
                  >
