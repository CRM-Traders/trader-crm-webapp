...
@Component({
  selector: 'app-affiliate-client-registration-modal',
  standalone: true,
    ...
    <div class="w-full">
      ...
      >
        <button
          *ngIf="!generatedPassword"
          type="button"
          class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
          (click)="onCancel()"
        >
          Cancel
        </button>
...
export class AffiliateClientRegistrationModalComponent {
  ...
  onSubmit() {
    ...
    const clientData: ClientCreateForAffiliateRequest = {
    ...
    this.clientsService.createClientForAffiliate(clientData).subscribe({
